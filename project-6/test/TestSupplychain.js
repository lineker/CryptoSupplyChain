...
contract('SupplyChain', accounts => {
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async() => {
        ...
        const resultBufferTwo = await supplyChain.fetchItemBufferTwo.call(upc);
        // console.log("upc: " + resultBufferTwo[1]);
        // console.log("State: " + resultBufferTwo[5]);
        // Verify the result set
        assert.equal(resultBufferTwo[1], upc, 'Error: Invalid item SKU');
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        const initial = toBN(await web3.eth.getBalance(distributorID));
        console.log(`Initial: ${initial.toString()}`);
        // Mark an item as Sold by calling function buyItem()
        let balance = web3.utils.toWei("2", "ether");
        let receipt = await supplyChain.buyItem(upc, {from: distributorID, value: balance});
        ...
        // Final balance
        const final = toBN(await web3.eth.getBalance(distributorID));
        console.log(`Final: ${final.toString()}`);
        const sum = Number(final)+(Number(gasPrice)*Number(gasUsed)) + Number(productPrice);
        console.log(`sum: ${sum.toString()}`);
        assert.equal(sum.toString(), initial.toString(), "Must be equal");
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        let receipt = await supplyChain.shipItem(upc, {from: distributorID});
        ...
        truffleAssert.eventEmitted(receipt, "Shipped");
    })    
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        let receipt = await supplyChain.receiveItem(upc, {from: retailerID});
        ...
        truffleAssert.eventEmitted(receipt, "Received");
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        let receipt = await supplyChain.purchaseItem(upc, {from: consumerID});
        ...
        truffleAssert.eventEmitted(receipt, "Purchased");
